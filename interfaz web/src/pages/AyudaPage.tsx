    ...
    <div style={{ background: '#f4f5f7', minHeight: '100%' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px 80px', width: '100%' }}>
        ...
        <Block icon="📊" title="Impacto">
          <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>Ve a "Impacto" para ver los datos en tiempo real: porcentaje de necesidades atendidas, avance por tipo y por sector. Se actualiza automáticamente cada 30 segundos.</p>
        </Block>
